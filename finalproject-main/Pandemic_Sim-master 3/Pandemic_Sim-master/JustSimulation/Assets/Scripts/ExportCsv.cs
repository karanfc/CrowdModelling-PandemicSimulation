...
public class ExportCsv : MonoBehaviour
{
    ...
    public void SaveToFile(string content)
    {
        ...
        var utcTimeStamp = System.DateTime.UtcNow;
        var filename = "export "+ timeStamp + ".csv";
        
        var filenameUTC = "export "+ utcTimeStamp + ".csv";
        var normalFileName = "export.csv";
        // var filePath = Path.Combine(folder, "export.csv");
        var filePath = Path.Combine(folder, normalFileName);
